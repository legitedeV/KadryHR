...
/**
 * Lokalny middleware autoryzacji dla modułu grafików.
 * Niezależny od istniejącego authMiddleware, żeby uniknąć konfliktów eksportów.
 */
async function auth(req, res, next) {
  try {
    ...
    console.error('Błąd w auth (scheduleRoutes):', err);
