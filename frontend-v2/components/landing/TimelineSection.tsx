              ...
              >
                ...
                <div className="mt-4 flex flex-wrap gap-2 text-xs">
                  {item.details.map((detail) => (
                    <span
                      key={detail}
                      className="rounded-full border border-surface-300 bg-surface-100 px-3 py-1 text-surface-600"
                    >
                      {detail}
                    </span>
                  ))}
                ...
                <div className="mt-4 flex gap-3">
                  <div className="flex-1 rounded-2xl border border-surface-300 bg-white p-3 text-xs text-surface-600">
                    <p className="text-surface-700">Dostępność zespołu</p>
                  ...
                  <div className="flex-1 rounded-2xl border border-surface-300 bg-white p-3 text-xs text-surface-600">
                    <p className="text-surface-700">Alerty zmian</p>
                    <div className="mt-2 flex items-center gap-2">
