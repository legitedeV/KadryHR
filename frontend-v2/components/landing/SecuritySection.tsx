    ...
    <section className="px-6 py-20" id="bezpieczenstwo">
      <div className="mx-auto max-w-6xl space-y-10">
        <div className="grid gap-6 md:grid-cols-[1.1fr_0.9fr]">
          ...
          <Reveal className="rounded-3xl border border-brand-800/60 bg-brand-950/40 p-6" delay={140}>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {items.map((item, index) => (
            <Reveal key={item.title} delay={160 + index * 70} className="rounded-3xl border border-surface-800/60 bg-surface-900/60 p-6 shadow-sm">
