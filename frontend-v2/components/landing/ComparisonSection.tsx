    ...
    <section className="relative bg-[#F7F9FB] py-24">
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="rounded-full border border-surface-300 bg-surface-100 px-6 py-3 text-sm text-surface-600">
            3 najczęstsze scenariusze operacyjne
          </div>
        </div>

        <div className="mt-10 rounded-[2.5rem] border border-surface-300 bg-gradient-to-br from-white/5 via-white/[0.02] to-transparent p-6">
          ...
          <div className="mt-6 space-y-6">
            {scenarios.map((scenario) => (
              <div
                key={scenario.title}
                className="grid gap-4 rounded-3xl border border-surface-300 bg-white/70 p-6 md:grid-cols-[1fr_auto_1fr] md:items-center"
              >
                <div>
