    ...
    <section className="relative overflow-hidden bg-[#0b1110]">
      ...
      <div className="mx-auto grid max-w-6xl gap-12 px-6 pb-24 pt-24 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="relative">
          ...
          <div className="rounded-[2.5rem] border border-white/10 bg-gradient-to-br from-white/5 via-white/[0.02] to-transparent p-8 shadow-[0_40px_90px_rgba(0,0,0,0.55)]">
            <div className="flex items-center justify-between text-xs text-white/60">
              <span>Panel kontrolny kadr</span>
              <span className="rounded-full border border-white/15 px-3 py-1">Tydzień 32</span>
            </div>
            <div className="mt-6 grid gap-4 lg:grid-cols-[1.3fr_0.7fr]">
              <div className="rounded-2xl border border-white/10 bg-[#111b18] p-4">
                ...
                <div className="mt-4 grid grid-cols-7 gap-2 text-[11px] text-white/70">
                  {[
                    "Pn",
                    "Wt",
                    "Śr",
                    ...
                    <div key={day} className="space-y-2">
                      <div className="text-white/40">{day}</div>
                      <div
                        className={`h-10 rounded-lg border border-white/10 bg-gradient-to-b ${
                          index === 2 || index === 5
                ...
                <div className="rounded-2xl border border-white/10 bg-[#111b18] p-4">
                  ...
                  <div className="mt-3 space-y-3 text-sm">
                    ...
                    <div className="flex items-center justify-between rounded-xl border border-white/10 bg-white/5 px-3 py-2">
                      ...
                      <span className="text-white/50">Brak</span>
                    </div>
                  </div>
                </div>
                <div className="rounded-2xl border border-white/10 bg-[#111b18] p-4">
                  ...
                  <div className="mt-4 space-y-2 text-sm">
                    ...
                    <button className="w-full rounded-xl border border-white/15 bg-white/5 px-4 py-2 text-left text-white/70 transition hover:border-white/30 hover:bg-white/10">
                      Zatwierdź RCP
                    </button>
                  </div>
                </div>
        ...
        <div className="flex flex-col justify-center gap-6">
          ...
          <div className="grid gap-4 pt-4 text-xs text-white/50 sm:grid-cols-3">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
              <div className="text-lg font-semibold text-white">99%</div>
