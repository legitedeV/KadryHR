...
export function TrustedBySection() {
  return (
    <section className="relative bg-[#F7F9FB] py-14">
      ...
      <div className="relative mx-auto max-w-5xl px-5">
        <div className="mx-auto flex max-w-3xl flex-col gap-4 text-center">
          ...
          <h2 className="text-2xl font-semibold text-surface-900 sm:text-3xl">
        ...
        <div className="mt-8 grid justify-items-center gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
