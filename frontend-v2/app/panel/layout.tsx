  ...
  return (
    <NotificationsProvider>
      <div className="min-h-screen flex panel-shell relative overflow-hidden">
        ...
        {/* sidebar */}
        <aside className="hidden md:flex md:flex-col w-64 rounded-r-3xl bg-gradient-to-b from-[#0b1411]/95 via-[#0f1b16]/95 to-[#0b1411]/95 border-r border-surface-800/70 shadow-[12px_0_40px_rgba(2,6,23,0.55)]">
          <div className="h-16 flex items-center gap-3 px-5 border-b border-surface-800/70 backdrop-blur">
        ...
        } bg-gradient-to-b from-[#0b1411]/95 via-[#0f1b16]/95 to-[#0b1411]/95 border-r border-surface-800/80`}>
          <div className="h-16 flex items-center justify-between gap-3 px-4 border-b border-surface-800/80">
            <Link href="/panel/dashboard" className="shrink-0">
        ...
        <div className="flex-1 flex flex-col">
          <header className="h-16 border-b border-surface-800/80 bg-gradient-to-r from-[#0b1411]/90 via-[#0f1b16]/90 to-[#0b1411]/90 px-4 lg:px-6 flex items-center justify-between gap-4 backdrop-blur">
