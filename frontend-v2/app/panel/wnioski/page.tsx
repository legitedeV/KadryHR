    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-lg font-bold text-surface-900 dark:text-surface-50 mt-1">Lista wniosków pracowników</p>
        </div>
                    ...
                    >
                      <td className="px-5 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="font-medium text-surface-900 dark:text-surface-100 text-sm">{r.employeeName}</span>
                        </div>
                      </td>
                      <td className="px-5 py-4 text-sm text-surface-600 dark:text-surface-300">{mapRequestType(r.type)}</td>
                    ...
                    <tr>
                      <td colSpan={4} className="px-5 py-10 text-center">
                        <div className="flex flex-col items-center">
                          ...
                          <p className="text-sm text-surface-500 dark:text-surface-400">Brak wniosków do wyświetlenia.</p>
                        </div>
                      </td>
                    </tr>
                  )}
          ...
          <div className="card p-6">
            {!selected ? (
              <div className="flex flex-col items-center justify-center h-full py-10 text-center">
                ...
                <p className="text-sm text-surface-500 dark:text-surface-400">Wybierz wniosek z listy, aby zobaczyć szczegóły.</p>
              </div>
            ) : (
              <div className="space-y-5">
                <div>
                  <p className="section-label">Szczegóły wniosku</p>
                  <p className="mt-2 text-lg font-bold text-surface-900 dark:text-surface-50">{mapRequestType(selected.type)}</p>
                </div>
