...
export default function RaportyPage() {
  ...
  async function downloadReport(type: "schedule" | "leaves", from: string, to: string) {
    ...
    try {
      ...
      const url = `${API_BASE_URL}/reports/${type}?from=${from}&to=${to}&format=csv`;
      ...
      <div className="panel-card p-6">
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-surface-400 mt-1">
              Eksportuj listę zmian dla wybranego okresu
            </p>
          </div>
        ...
        <button
          onClick={() => downloadReport("schedule", scheduleFrom, scheduleTo)}
