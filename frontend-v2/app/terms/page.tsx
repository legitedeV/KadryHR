    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-4xl px-6 py-16 space-y-8">
        <header className="space-y-4">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-brand-600">Regulamin</p>
        ...
        <section className="space-y-3 text-sm text-surface-600 dark:text-surface-300">
          <h2 className="text-lg font-semibold text-surface-900 dark:text-surface-50">Zakres usług</h2>
          <p>KadryHR dostarcza narzędzia do planowania grafiku, rejestracji czasu pracy i zarządzania urlopami.</p>
        </section>
        <section className="space-y-3 text-sm text-surface-600 dark:text-surface-300">
          <h2 className="text-lg font-semibold text-surface-900 dark:text-surface-50">Odpowiedzialność</h2>
          <p>Zapewniamy dostępność systemu zgodnie z planem SLA oraz wsparcie w dni robocze.</p>
        </section>
        <section className="space-y-3 text-sm text-surface-600 dark:text-surface-300">
          <h2 className="text-lg font-semibold text-surface-900 dark:text-surface-50">Rezygnacja</h2>
