        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          <div className="card p-8 space-y-6">
            <div className="flex items-center gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-900/50 text-brand-300">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 p-4 rounded-xl bg-surface-800/50">
                ...
                <div>
                  <p className="text-xs font-medium text-surface-400">E-mail</p>
                  <p className="text-sm font-semibold text-surface-50">kontakt@kadryhr.pl</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-4 rounded-xl bg-surface-800/50">
                ...
                <div>
                  <p className="text-xs font-medium text-surface-400">Telefon</p>
                  <p className="text-sm font-semibold text-surface-50">+48 500 600 700</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-4 rounded-xl bg-surface-800/50">
                ...
                <div>
                  <p className="text-xs font-medium text-surface-400">Godziny pracy</p>
                  <p className="text-sm font-semibold text-surface-50">Pon–Pt, 9:00–17:00</p>
                </div>
              </div>
            </div>
          </div>
