...
const consoleNavItems: ConsoleNavItem[] = [
  ...
  { href: "/console/frontend", label: "Frontend Config", icon: "M10 3H5a2 2 0 00-2 2v5m7-7h9a2 2 0 012 2v5m-11 8v3a2 2 0 002 2h5m-7-7H5a2 2 0 01-2-2v-5m7 7h9a2 2 0 002-2v-5" },
  { href: "/console/backend", label: "Backend Config", icon: "M5.25 8.25h13.5m-13.5 7.5h13.5M3.75 5.25h16.5a2.25 2.25 0 012.25 2.25v9a2.25 2.25 0 01-2.25 2.25H3.75A2.25 2.25 0 011.5 16.5v-9a2.25 2.25 0 012.25-2.25z" },
