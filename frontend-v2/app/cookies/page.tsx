    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-4xl px-6 py-16 space-y-8">
        <header className="space-y-4">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-brand-600">Cookies</p>
        ...
        <section className="space-y-3 text-sm text-surface-600 dark:text-surface-300">
          <h2 className="text-lg font-semibold text-surface-900 dark:text-surface-50">Niezbędne</h2>
          <p>Służą do działania serwisu, zapamiętania preferencji i bezpieczeństwa sesji.</p>
        </section>
        <section className="space-y-3 text-sm text-surface-600 dark:text-surface-300">
          <h2 className="text-lg font-semibold text-surface-900 dark:text-surface-50">Analityczne</h2>
          <p>Pomagają nam rozumieć sposób korzystania z aplikacji i poprawiać UX.</p>
        </section>
        <section className="space-y-3 text-sm text-surface-600 dark:text-surface-300">
          <h2 className="text-lg font-semibold text-surface-900 dark:text-surface-50">Marketingowe</h2>
