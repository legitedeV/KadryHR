        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              <Link
                to="/login"
                className="inline-flex items-center gap-2 rounded-full border-2 border-pink-200 bg-white px-8 py-4 text-base font-semibold text-pink-700 hover:bg-pink-50 transition-all duration-200"
              >
                Zobacz demo
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            <div className="text-white font-semibold text-sm">Bezpieczne połączenie</div>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            <div className="text-white font-semibold text-sm">Szybkie działanie</div>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            <div className="text-white font-semibold text-sm">Zgodność z RODO</div>
                            <div className="text-white/60 text-xs">Pełna ochrona danych</div>
                          </div>
                        </div>
                      </div>
                    </div>
