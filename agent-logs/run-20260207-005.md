...
## 2026-02-07 Fix: readonly handler TDZ

- Reordered lifecycle readonly handler so `disableEditMode` is initialized before use to avoid runtime "Cannot access before initialization".
- Files touched: frontend-v2/features/schedule-v2/SchedulePage.tsx
- Tests: not rerun in this fix.
